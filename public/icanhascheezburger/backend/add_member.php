...
if( isset( $_POST["join"] ) && $_POST["join"] == "yes" ) {
   ...
   $goahead = false;
   $diemsg = "<p$errorstyle><strong>Oops!  There is a problem...</strong><br /><br />";
   $diemsg .= "Your application did not submit for one or more of the following problems:</p>";
   $diemsg .= "<ul><li>There are bad strings found in the form</li><li>You have been identified as a spammer</li>";
   $diemsg .= "<li>Your email address has been banned from this fanlisting</li>";
   $diemsg .= "<li>Your website has been banned from this fanlisting</li></ul>";
   ...
   // Also added latest spammer domains to deny them access. (NF)
